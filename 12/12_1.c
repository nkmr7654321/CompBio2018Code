...
int main(){
  int i,j;
  double a,A,b,c,dh,dr,m,P,n,p,t,T,dt,Th,xmax_ex,alpha,beta,gamma,s,score,xmax_th,
  x[3],xx[3];
  //ファイルを開く
  FILE *fp;
  fp=fopen("allergy_ode_C.csv","w");
  //患者の置かれた条件に当たるパラメータ
